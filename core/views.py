...
MODULOS = [
    ...
    {"nombre": "Cotizaciones", "icono": "🧾", "url": "ventas:cotizacion_list"},
    {"nombre": "Devolución de Venta", "icono": "↩️", "url": "ventas:devolucion"},
    {"nombre": "Cuentas por Cobrar", "icono": "💵", "url": "ventas:cuentas_por_cobrar"},
    {"nombre": "Cierre de Caja", "icono": "🧮", "url": "ventas:cierre_list"},
    ...
    {"nombre": "Cuentas por Pagar", "icono": "💳", "url": "compras:cuentas_por_pagar"},
    {"nombre": "Productos", "icono": "📦", "url": "productos:list"},
    {"nombre": "Inventario", "icono": "🏬", "url": "inventario:list"},
    {"nombre": "Lotes y Vencimientos", "icono": "⏳", "url": "inventario:lote_list"},
